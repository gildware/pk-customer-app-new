...
class RouteHelper {
  ...
  static const String allServiceScreen = '/services';
  ...
  static const String providerDetailsScreen = '/provider';
  ...
  static String allServiceScreenRoute(String fromPage, {String campaignID = '', String? title}) {
    var route = '$allServiceScreen?fromPage=${Uri.encodeComponent(fromPage)}&campaignID=$campaignID';
    if (title != null && title.trim().isNotEmpty) {
      route += '&title=${Uri.encodeComponent(title.trim())}';
    }
    return route;
  }
  static String getFeatheredCategoryService(String fromPage, String categorySlug) => '$featheredServiceScreen?fromPage=$fromPage&categorySlug=$categorySlug';
  ...
  static String getProviderDetails(String providerId) => '$providerDetailsScreen/$providerId';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          bool fromAddress = Get.parameters['page'] == 'add-address' ||
              Get.parameters['page'] == 'add-addres';
          ZoneModel? zoneData;
    ...
    GetPage(
      ...
      page: () {
        return getRoute(Get.arguments ?? ServiceDetailsScreen(
          serviceID: Get.parameters['slug'],fromPage: Get.parameters['fromPage'],
    ...
    // Cancellation & refund policy pages removed from app menus — routes disabled.
    // GetPage(
    ...
    GetPage(binding: ServiceBinding(),name: allServiceScreen, page:  ()=> getRoute(AllServiceView(
      fromPage: Get.parameters['fromPage'],
    ...
    GetPage(name: '$providerDetailsScreen/:id', page:() => getRoute(
  ...
  static Widget getRoute(
    ...
    }) || !kIsWeb) || isIgnoreRouteExistCheck;
