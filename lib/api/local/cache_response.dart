...
class AppDatabase extends _$AppDatabase {
  ...
  Future<int> deleteCacheResponseByEndPoint(String endPoint) async {
    return await (delete(cacheResponse)..where((tbl) => tbl.endPoint.equals(endPoint)))
        .go();
  }
