...
class Advertisement {
  ...
  String? providerShowcase;
  List<ProviderShowcaseItem>? showcaseItems;
  ...
  Advertisement.fromJson(Map<String, dynamic> json) {
    ...
    providerReview = json['provider_review']?.toString();
    providerRating = json['provider_rating']?.toString();
    providerShowcase = json['provider_showcase']?.toString();
    if (json['showcase_items'] != null) {
      showcaseItems = <ProviderShowcaseItem>[];
      json['showcase_items'].forEach((v) {
        showcaseItems!.add(ProviderShowcaseItem.fromJson(v));
      });
    }
