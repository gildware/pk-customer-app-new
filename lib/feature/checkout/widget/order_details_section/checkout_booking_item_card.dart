...
class CheckoutBookingItemCard extends StatefulWidget {
  ...
  @override
  State<CheckoutBookingItemCard> createState() => _CheckoutBookingItemCardState();
}

class _CheckoutBookingItemCardState extends State<CheckoutBookingItemCard> {
  ...
  AddressModel? get _bookingAddress =>
      CartBookingDisplayHelper.resolveAddressForCartItem(cart);
            ...
            InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _ServiceThumbnail(thumbnail: _thumbnail),
                        ...
                        Directionality(
                          ...
                          child: Text(
                            PriceConverter.convertPrice(
                              cart.lineTotalWithCharges.toDouble(),
                            ),
                            style: robotoBold.copyWith(
...
class _ServiceThumbnail extends StatelessWidget {
  ...
  const _ServiceThumbnail({this.thumbnail});
