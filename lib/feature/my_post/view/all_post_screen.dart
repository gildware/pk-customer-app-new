...
class AllPostScreen extends StatelessWidget {
  ...
  const AllPostScreen({super.key, this.fromNotification, this.embedInBottomNav = false}) ;
  @override
  ...
  Widget screen = Scaffold(
        appBar: embedInBottomNav ? CustomAppBar(
          title: 'biddings'.tr,
          isBackButtonExist: false,
        ) : CustomAppBar(title: 'my_posts'.tr, onBackPressed: (){
